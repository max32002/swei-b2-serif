...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-b2-serif/raw/master/WebFont/CJK%20TC/SweiB2SerifCJKtc-Regular.woff2) format("woff2")
  , url(https://github.com/max32002/swei-b2-serif/raw/master/WebFont/CJK%20TC/SweiB2SerifCJKtc-Regular.woff) format("woff");
}
```
